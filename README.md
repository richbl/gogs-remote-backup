...
This project uses [Git submodule projects](https://git-scm.com/book/en/v2/Git-Tools-Submodules) (located in the `postgresql-db-dump` and the `remote-folder-copy` folders) to keep this project up-to-date without manual intervention.
